    ...
    return {
        ...
        createThirdPartySale: function(appId, planId) {
            ...
            try {
                ...
                _createThirdPartySaleInAnalytics(appId, {planId: planId}).then(function() {
                ...
                User.findOne({
                    ...
                    Card.findOne({
                        ...
                        if (data) {
                            ...
                            var sameCard = data.cards.filter(function(obj) {
                                return obj.number_actual === cardDetails.number_actual;
                            })[0];
                            if (sameCard)
