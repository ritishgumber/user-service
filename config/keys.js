module.exports = {
	...
	cors : ['http://localhost:1440','http://localhost:1444','http://localhost:1441','https://www.cloudboost.io', 'http://www.cloudboost.io','http://dashboard.cloudboost.io','https://dashboard.cloudboost.io','http://cloudboost.io','https://cloudboost.io','http://cloudboostvm.cloudapp.net'],
...
//	 db : global.isDevelopment ? 'mongodb://CloudBoost:WhiteHouse123@ds030817.mongolab.com:30817/CloudBoostDevDB' : 'mongodb://CloudBoost:WhiteHouse123@ds041177.mongolab.com:41177/CloudBoostProdDB',
	...
	redisURL : global.isVM?'localhost':(global.isDevelopment ? 'cbtest.redis.cache.windows.net' : 'cbredis.redis.cache.windows.net'),
	redisPort : 6379,
	redisPassword : global.isVM?'':(global.isDevelopment ? 'ClWpbDmFSaJ+RzTvR9tu+aM6MUEK1oh2FcsXCLhh5+Y=' : 'Lu40rnq6AccYY2t9DL0yeldebmth/Uz6pgZceg13eek='),
