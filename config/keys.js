module.exports = {
	...
	redisURL : global.isVM?'localhost':(global.isDevelopment ? 'cbcachetest.redis.cache.windows.net' : 'cbcacheproduction.redis.cache.windows.net'),
	redisPort : 6379,
	redisPassword : global.isVM?'':(global.isDevelopment ? 'bXmhmbA3Y5h+ay1DjP+QvD0w89JArE75gEIJh8FZ1HQ=' : 'WdlsLwonsF8mT1SqRjpI6dF9jzya3lBAm//HbCJK1vQ='),
